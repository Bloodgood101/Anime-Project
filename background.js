...
function startAnime() {
  ...
  var getAnime = document.getElementById("anime");
  const animeName = getAnime.value;

  var divLine = document.getElementById("confirmation");
  ...
  animeNameUrl = animeName.replace(/ /g, "+");
  //Our torrent website
  var url = 'https://1337x.to/search/'+animeNameUrl+'/1/';
  fetch(url, {
    mode: 'no-cors'
  }) 
